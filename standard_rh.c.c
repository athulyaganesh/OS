// Operating Systems HW SEVEN 
// Standard Resource Hierarchy Solution 
   ...
   {  // In this version of the "philosopher program", the philosopher
      ...
      while (MEALS_ON_TABLE > 0)
         { // Philosophers always think before they eat.  They need to 
           ...
           //ATHULYAS COMMENTS: EVERY PHILOSOPHER GETS TWO CHOPSTICKS (LEFT, AND RIGHT) 
           
           int left = philosopher_number; 
           int right = (philosopher_number + 1)%PHILOSOPHER_COUNT; 
           
           //ATHULYAS COMMENTS: PICK THE LOWER FORK AND THEN THE HIGHER FORK 
